    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.ForeignKey(to='hv_curriculum.Level')),
            ],
            options={
            },
            bases=(models.Model, utils.mixins.TranslatedModelMixin),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(to='hv_curriculum.Page')),
                ('user', models.ForeignKey(related_name='hv_per_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(to='hv_curriculum.Question')),
                ('user', models.ForeignKey(related_name='hv_rsp_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='page',
            name='section',
            field=models.ForeignKey(to='hv_curriculum.Section'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='edge',
            name='u',
            field=models.ForeignKey(related_name='from_page', to='hv_curriculum.Page'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='edge',
            name='v',
            field=models.ForeignKey(related_name='to_page', to='hv_curriculum.Page'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='choice',
            name='question',
            field=models.ForeignKey(to='hv_curriculum.Question'),
            preserve_default=True,
        ),
    ]
